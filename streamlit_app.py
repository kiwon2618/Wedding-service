...
# ============================================================================================
#              🌸 고급 + 은은한 웨딩 배경 (흰 꽃 + 깃털 + 웨딩사진 3중 배경)
# ============================================================================================
st.markdown(
    """
    <style>
    ...
    .title-main {
        ...
        color: #d48593;
        letter-spacing: 1px;
        text-shadow: 0px 0px 6px rgba(255, 220, 230, 0.55);
        margin-top: 15px;
    }
...
st.markdown(
    ...
    <div style="text-align:center; padding:38px 10px;">
        ...
        <p style="font-family:'Gowun Batang'; color:#a18478; font-size:0.92rem;">
